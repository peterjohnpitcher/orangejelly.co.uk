...
export default function AvailabilityStatus() {
  ...
  const getAvailabilityStatus = () => {
    ...
    return {
      status: 'normal',
      message: "I personally reply to every message. During service? I'll get back to you after. Otherwise, expect a reply within a few hours",
      color: 'text-charcoal'
    };
  };
  ...
  return (
    <Card background="cream" className="mb-6">
      <Heading level={3} className="mb-2">Right Now:</Heading>
      <p className={`${availability.color} font-medium`}>
