...
export const metadata = generatePageMetadata({
  ...
  description: 'The page you are looking for could not be found. Let us help you find what you need to fill your pub.',
  path: '/404',
  noIndex: true,
});
        ...
        <Section>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Text size="lg" className="mb-8 max-w-2xl mx-auto">
              The page you're looking for seems to have wandered off like a customer 
              to the pub down the road. But don't worry - we've got plenty of ways 
              to help you fill those empty tables.
            </Text>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Grid columns={{ default: 1, md: 2 }} gap="medium">
              <Card variant="bordered" padding="medium">
                <Heading level={3} className="mb-4">Empty Pub Solutions?</Heading>
                <Text className="mb-4">
                  If your tables are sitting empty, we've got proven strategies 
                  to fill them - fast.
                </Text>
                <Button 
              ...
              <Card variant="bordered" padding="medium">
                <Heading level={3} className="mb-4">Marketing Help?</Heading>
                <Text className="mb-4">
                  Stop wasting time on social media. Let us handle your marketing 
              ...
              <Card variant="bordered" padding="medium">
                <Heading level={3} className="mb-4">Menu Makeover?</Heading>
                <Text className="mb-4">
                  Turn your menu into a profit machine with descriptions that 
                  make mouths water.
                </Text>
                <Button 
              ...
              <Card variant="bordered" padding="medium">
                <Heading level={3} className="mb-4">Success Stories?</Heading>
                <Text className="mb-4">
                  See how we've helped other pubs go from empty to packed 
                  with real results.
                </Text>
                <Button 
                  href="/results" 
        ...
        <Section>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Text size="lg" className="mb-8">
              No problem! I'm Peter, and I run The Anchor pub. Let's have a chat 
              about what's keeping you up at night - I've probably been there too.
            </Text>
