      ...
      <Section background="white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
          <div className="text-center p-6 bg-cream rounded-lg">
            ...
            <Text size="sm" className="text-charcoal/70">Proven strategies from The Anchor</Text>
          </div>
          <div className="text-center p-6 bg-cream rounded-lg">
            <div className="text-3xl font-bold text-orange mb-2">71%</div>
            <Text size="sm" className="text-charcoal/70">Food GP achieved using these methods</Text>
          </div>
          <div className="text-center p-6 bg-cream rounded-lg">
            <div className="text-3xl font-bold text-orange mb-2">£75k+</div>
            <Text size="sm" className="text-charcoal/70">Added to business value</Text>
          </div>
        </div>
        ...
        <div className="prose prose-lg max-w-3xl mx-auto mb-12">
          <Text className="mb-4">
            Every guide in this collection comes from real experience at The Anchor in Stanwell Moor. 
            We've tested these strategies firsthand, measuring their impact on our bottom line.
          </Text>
          <Text className="mb-4">
            Whether you're struggling with empty Tuesday nights, competing with Wetherspoons, or 
            trying to build a profitable food offering, you'll find honest, practical advice that works.
          </Text>
          <Text className="mb-8">
        ...
        <div className="bg-teal-dark/5 rounded-xl p-8 mb-12 max-w-4xl mx-auto">
          <Heading level={2} align="center" className="mb-6">What You'll Learn</Heading>
        ...
        {/* Category Navigation */}
        <div className="mb-12">
          <Heading level={2} align="center" className="mb-6">Browse by Topic</Heading>
