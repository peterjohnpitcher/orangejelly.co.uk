        ...
        <AnimatedItem animation="fade-in">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Text size="xl" color="muted" align="center" className="mb-8">
              Every empty chair costs you £30-50 in lost revenue. A half-empty pub on 
              weeknights means you're losing £15,000+ per month. That's £180,000 a year 
              walking past your door.
            </Text>
            <div className="bg-orange-light rounded-lg p-6">
              <Text size="lg" weight="semibold" align="center">
                The worst part? Your fixed costs stay the same whether you serve 
                10 customers or 100. Empty pubs bleed money fast.
              </Text>
            </div>
          </div>
        </AnimatedItem>
            ...
            {solutions.map((week, index) => (
              <div key={index} id={`week-${index + 1}`}>
                <Card background="white" padding="medium">
                  <Heading level={3} color="orange" className="mb-2">{week.week}</Heading>
                  <Heading level={4} className="mb-4">{week.title}</Heading>
                  <FeatureList 
                    items={week.actions} 
                    icon="check" 
                    iconColor="teal" 
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Grid columns={{ default: 1, md: 2 }} gap="large">
              <Card variant="colored" background="orange-light" padding="large">
                <Heading level={3} className="mb-4">Done-For-You Setup</Heading>
                <FeatureList
                  items={[
              ...
              <Card variant="colored" background="teal-dark" padding="large">
                <Heading level={3} color="white" className="mb-4">Ongoing Support</Heading>
