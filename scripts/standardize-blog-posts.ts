...
function generateQuickAnswer(title: string, content: any[]): string {
  ...
  if (titleLower.includes('gp') || titleLower.includes('gross profit') || titleLower.includes('margin')) {
  ...
  if (titleLower.includes('quiet') || titleLower.includes('tuesday') || titleLower.includes('midweek')) {
  ...
  if (titleLower.includes('seasonal') || titleLower.includes('christmas') || titleLower.includes('summer')) {
...
function generateFAQs(title: string, content: any[]): any[] {
  ...
  const universalFAQs = [
    {
      ...
      answer: 'Most strategies show initial results within 2-4 weeks. Quiz nights attract regulars immediately, social media engagement grows within days, and operational improvements like GP optimization show impact in the first month. Full transformation typically takes 3-6 months of consistent implementation.',
    ...
    },
    {
      ...
      answer: 'Implementation costs vary by strategy. Many improvements like social media optimization and operational changes cost nothing beyond time. Events may require £50-200 initial investment. Professional support is available at £62.50 per hour plus VAT.',
      isVoiceOptimized: true
    },
    {
    ...
    faqs.push(
      {
        ...
        answer: 'The primary cause is usually poor visibility and communication. Customers don\'t know what\'s happening at your pub. Secondary factors include atmosphere, value perception, and competition. Fixing visibility through social media and events typically increases footfall by 30-40%.',
        isVoiceOptimized: true
      },
      {
        ...
        answer: 'Tuesday is typically the quietest day for most pubs, followed by Monday and Wednesday. Combat this with specific midweek offers, regular events like quiz nights, and targeted social media campaigns. The Anchor increased Tuesday revenue by 40% using these strategies.',
        isVoiceOptimized: true
      }
    );
  }
    ...
    faqs.push(
      {
        ...
        answer: 'Tuesday or Wednesday typically work best as they boost quiet midweek trade. Avoid Fridays and Saturdays when you\'re already busy. The Anchor runs successful Tuesday quizzes with 25-35 regular attendees.',
        isVoiceOptimized: true
      },
      {
        _key: generateKey('faq', 4),
        ...
        answer: 'Budget £30-50 for prizes. First prize £20-30, second £10-15, third £5-10. This investment typically generates £200-300 additional revenue per quiz night through food and drink sales.',
        isVoiceOptimized: true
      }
    );
  }
    ...
    faqs.push(
      {
        ...
        answer: 'Target 45-55% gross profit on food. The Anchor improved from 58% to 71% through portion control, menu engineering, and waste reduction. This improvement added £15,000 annual profit.',
        isVoiceOptimized: true
      },
      {
        _key: generateKey('faq', 4),
        ...
        answer: 'Implement portion control, improve stock rotation, use prep lists, and monitor waste daily. The Anchor reduced Sunday lunch waste by £250 weekly through better planning and portion management.',
        isVoiceOptimized: true
      }
    );
  }
    ...
    faqs.push(
      {
        ...
        answer: 'Post daily on Facebook and Instagram. Share opening times, daily specials, events, and customer photos. The Anchor achieves 60,000-70,000 monthly views with consistent daily posting.',
        isVoiceOptimized: true
      },
      {
        _key: generateKey('faq', 4),
        ...
        answer: 'Facebook remains most effective for pubs, especially for the 35+ demographic. Instagram works well for food photos and younger customers. Focus on one platform properly rather than spreading efforts thin.',
        isVoiceOptimized: true
      }
    );
  }
    ...
    faqs.push(
      {
        ...
        answer: 'Offer competitive wages, flexible scheduling, clear training, and regular feedback. Create team incentives and social events. Reducing turnover saves recruitment costs and improves service consistency.',
        isVoiceOptimized: true
      },
      {
        _key: generateKey('faq', 4),
        ...
        answer: 'Depends on covers and service style. Generally: 1 staff per 20-30 covers for bar service, 1 per 15-20 for table service. Use sales data to optimize rotas and reduce labor costs to 25-30% of revenue.',
        isVoiceOptimized: true
      }
    );
  }
  ...
  while (faqs.length < 5) {
    faqs.push({
      ...
      answer: 'Yes, payment plans are available to help with cash flow. Services are charged at £62.50 per hour plus VAT. Contact us to discuss a payment arrangement that works for your business.',
