...
import { writeClient as client } from '../src/lib/sanity.write-client.js';
...
const aboutContentData = {
  ...
  founderSection: {
    ...
    // Using existing image reference from the schema defaults
    image: {
      _type: 'image',
      asset: {
        _type: 'reference',
        _ref: 'image-peter-pitcher-svg' // This may need to be updated with actual asset ID
      }
    }
  },
  quickFacts: {
