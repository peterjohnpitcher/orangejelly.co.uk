...
featuredImage: /images/blog/midweek-pub-offers.svg
seo:
  title: 'Midweek Pub Offers That Work: 14 Profitable Promotions'
  description: >-
    Transform quiet midweek nights with proven pub offers that increase profits,
    not just footfall. Real examples and results from successful UK pubs.
  keywords:
    - midweek pub offers
    - wednesday pub promotions
...
2. **Midweek to weekend ratio** (avoid cannibalisation)
3. **New customer acquisition** (fresh faces matter)
4. **Return rate** (one-hit wonders don't build business)
5. **Staff cost percentage** (busy but profitable)
