// Sanity Migration Script for Landing Page Content (TypeScript)
// This script contains all the extracted content from the landing pages
// with proper type definitions for the landingPageContent schema
...
const landingPageContent: LandingPageContent[] = [
  ...
  // ==========================================
  {
    ...
    sections: {
      problem: {
        ...
        summary: "4 quiet nights × 52 weeks = £230,400 lost annually"
      },
      ...
      successMetrics: {
        title: "Real Transformations in Real Pubs",
        stories: [
          {
      ...
      timeline: {
        title: "Your Midweek Recovery System",
        phases: [
          {
  ...
  // ==========================================
  {
    ...
    sections: {
      comparison: {
        title: "The Chain Pub Threat is Real",
        theyHave: [
      ...
      successMetrics: {
        title: "Pubs That Beat the Chains",
        stories: [
          {
            pub: "The Fox & Hounds",
      ...
      battlePlan: {
        title: "Your Chain-Beating Battle Plan",
        immediate: {
        ...
        investment: "£62.50/hour plus VAT - Most pubs see positive impact within 2 weeks"
      }
    },
  ...
  // ==========================================
  {
    ...
    sections: {
      ...
      templates: {
        title: "Copy-Paste Social Media Posts That Fill Tables",
        description: "These exact posts have generated thousands in revenue. Just adapt to your pub:",
        items: [
          {
      ...
      hiddenOpportunities: {
        title: "Free Marketing Gold Mines Most Pubs Miss",
        items: [
          {
...
export async function migrateLandingPages(client: SanityClient): Promise<void> {
...
export default migrateLandingPages;